...
impl Inspector {
    pub fn tab_button(
        ui: &mut egui::Ui,
        current: &mut InspectorTab,
        tab: InspectorTab,
        title: &str,
    ) {
        if ui
            .selectable_label(*current == tab, title)
            .clicked()
        {
            *current = tab;
        }
    ...
    pub fn show(
        ui: &mut egui::Ui,
        selected_tab: &mut InspectorTab,
        dock: &mut InspectorDock,
        ...
        ui.horizontal(|ui| {
            ...
            ui.menu_button("...", |ui| {
                ui.label(
                    egui::RichText::new("Dock Inspector").strong(),
                );
